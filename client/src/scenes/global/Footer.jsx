    ...
    <Box mt="70px" p="40px 0" backgroundColor={neutral.light}>
      ...
      >
        <Box width="clamp(20%, 30%, 40%)">
            ...
            <div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate quo iusto numquam. Nesciunt officia temporibus exercitationem obcaecati quasi vero aliquid, quis eligendi maxime debitis at error odio fugiat quos quisquam?
            </div>
        </Box>
        ...
        <Typography variant="h4" fontWeight="bold" mb="30px">Contact Us</Typography>
          <Typography mb="30px">50 north Green blvd, Washington DC 10501</Typography>
          <Typography mb="30px">Email: fakeemail@gmail.com</Typography>
